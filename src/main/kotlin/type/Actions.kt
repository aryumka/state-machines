...
sealed class Actions {
  ...
  data class PaymentMade(override val message: String = "payment is made"): Actions()
  data class OrderShipped(override val message: String = "order is shipped"): Actions()
  data class OrderDelivered(override val message: String = "order is delivered"): Actions()
